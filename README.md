...
| [`courses/mHnoznNqlis`](courses/mHnoznNqlis) | The Complete Blender Mastercourse, Part 1 (12 h, 37 build chapters) | the interface to geometry nodes, each chapter building on the last: a Rubik's cube, a table scene with a computer, modelling tools, every Generate and Deform modifier, shader and texture nodes, a baked PBR set, vertex paint, glass/chrome/gold assets, a cloth simulation, light linking, keyframes, the graph editor and the NLA, 3D text; then eleven geometry-nodes projects: a snowman, a city, fences along curves, a landscape with grass and rocks, a house generator, donuts with sprinkles, a meteor destroying a city, a sci-fi corridor fly-through and a neon billboard whose counter counts to 41; [`grid.jpg`](courses/mHnoznNqlis/grid.jpg) (every chapter), [`overview.jpg`](courses/mHnoznNqlis/overview.jpg), animated chapters in `videos/` |
